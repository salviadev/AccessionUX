...
namespace Accession {
    const
        ...
        _utils = _p.utils,
        _data = _p.data;
    export class ParametrageEditionProcedureModels extends Phoenix.ui.FormController {
    ...
    _customData.register('accession.sync.editions.parametrage-procedure-models.controller', new ParametrageEditionProcedureModels());
}